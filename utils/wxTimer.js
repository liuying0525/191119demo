...
wxTimer.prototype = {
	...
	start:function(self){
	    ...
	    function begin(){
        var tmpTime = new Date(that.endTime - 30000 * count++);
          ...
          var wxTimerSecond = (tmpTime.getTime() - new Date("1970/01/01 00:00:00").getTime()) / 30000;
	    ...
	    begin();
      this.intervarID = setInterval(begin, 30000);
	},
	//结束
	stop:function(){
